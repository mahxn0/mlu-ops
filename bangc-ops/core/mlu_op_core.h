...
typedef enum {
  ...
  MLUOP_DTYPE_UINT16 = 13,   /*!< The data is a 16-bit unsigned integer data type. */
  MLUOP_DTYPE_UINT32 = 11,   /*!< The data is a 32-bit unsigned integer data type. */
  MLUOP_DTYPE_UINT64 = 12,   /*!< The data is a 64-bit unsigned integer data type. */
  MLUOP_DTYPE_DOUBLE = 14,   /*!< The data is a 31-bit signed integer data type. */
  MLUOP_DTYPE_COMPLEX_HALF = 15,  /*!< The data is a 32-bit complex number of two fp16. */
  MLUOP_DTYPE_COMPLEX_FLOAT = 16, /*!< The data is a 64-bit complex number of two fp32. */
} mluOpDataType_t;
